/**
 * THREE.DRACOLoader - Loader for Draco compressed geometry
...
( function () {
	...
	class DRACOLoader extends THREE.Loader {
		...
		parse( buffer, onLoad, onError ) {
			...
			this.decodeDracoFile( buffer, onLoad, null, null, THREE.sRGBEncoding ).catch( onError );

		}

		decodeDracoFile( buffer, callback, attributeIDs, attributeTypes, vertexColorSpace = THREE.LinearEncoding ) {
		...
		_assignVertexColorSpace( attribute, inputColorSpace ) {
			...
			if ( inputColorSpace !== THREE.sRGBEncoding ) return;
		...
		_initDecoder() {
			...
			this.decoderPending = Promise.all( librariesPending )
				.then( ( libraries ) => {
					...
					const fn = DRACOLoader.DRACOWorker.toString();
